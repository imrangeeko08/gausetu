...
const DevotionLegacy = () => {
  return (
    <section
      className="bg-cover bg-center bg-no-repeat md:py-16 "
  
    >
      <div className="max-w-6xl mx-auto text-center text-gray-800">
        <h2 className="text-xl sm:text-3xl md:text-4xl font-bold mb-6">Where Devotion Meets Legacy</h2>
        ...
        <div className="relative bg-black h-max rounded-lg overflow-hidden shadow-lg mb-8">
          <Image
            src="/images/devotion_img.svg"
            alt="Historical Devotion"
            width={1200}
            height={600}
            className="w-full min-h-[200px] object-cover opacity-80"
          />
          <div className="absolute inset-0 flex items-center justify-center px-6">
            <p className="text-white text-lg sm:text-xl font-medium text-center">
              <span className="text-xl md:text-4xl font-bold leading-none">“</span> In those times, not only did the waters serve human needs, but even arrangements were made to grow “Leela Chara” — divine fodder — for cows on the pal (banks) near ancient temples.
            </p>
          </div>
        </div>

        <p className="text-base sm:text-xl mb-4 text-[#696969]">
        ...
        <p className="text-base sm:text-xl mb-6 text-[#696969]">
